...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Citation::class, mappedBy="createdBy")
     */
    private $citations;

    /**
     * @ORM\OneToMany(targetEntity=Commentaire::class, mappedBy="createdBy")
     */
    ...
    public function removeCitation(Citation $citation): self
    {
        if ($this->citations->removeElement($citation)) {
            ...
            if ($citation->getCreatedBy() === $this) {
                $citation->setCreatedBy(null);
            }
        }
